        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          {links.map((link) => (
            <Link
              key={link.label}
              href={link.href}
              className="px-4 py-2 rounded-lg text-sm text-gray-300 hover:text-white hover:bg-white/10 transition"
            >
              {link.label}
            </Link>
          ))}
          ...
          <div className="ml-4 flex items-center gap-2">
            ...
            <Link
              href="/login"
              className="px-4 py-2 rounded-lg border border-white/20 text-white text-sm hover:bg-white/10 transition"
            >
              Entrar
            </Link>
